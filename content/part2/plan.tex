\chapter{Implication du microbiote dans la réponse au stress de température} % (fold)
	\label{sec:implicationµbiote}
		\input{content/part2/intropart2}

	\section{Stimulation de l'expression de gènes de l'hôte} % (fold)
		\label{sec:gènes_hôte}
			\input{content/part2/gènes_hôte}

	\section{Utilisation par l'hôte de protéines microbiennes} % (fold)
	 	\label{sec:gènes_microbiens}
	 		\input{content/part2/gènes_bactos}

	\section{Autres mécanismes} % (fold)
		\label{sec:autres_m_canismes}
			\input{content/part2/autres}
	...
	%  		\input{content/part2/diminution_antagonisme}
