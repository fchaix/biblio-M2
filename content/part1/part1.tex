...
phénomènes d'acclimatation suite à un stress ponctuel dans le temps, exercé à l'échelle des individus.
	...
	\section{Exemples de réponse chez les insectes}
		...
		% Protéomique sur le stress chaud chez le puceron Nguyen2009
		...
		% →→ On ne va pas parler tout de suite de protéomique, mais on va citer Nguyen2009 pour la cinétique.
		% Il y a dans cette publi dans la discussion des éléments intéressants pour parler de la réponse HS.
