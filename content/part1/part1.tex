...
%		Leur action stimulatrice entraîne (complète stp en décrivant l'effet positif pour l'insecte, maintien, équilibre, … ?). 
		...
		Chez la mouche \esp{Drosophila melanogaster}, il a été montré qu'un pré-traitement avec des chocs froids successifs permettait de prémunir l'insecte contre ce phénomène.
